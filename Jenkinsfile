pipeline {
    ...
    parameters {
        ...
        choice(name: 'SUITE', choices: ['src/test/java/suites/smokeTests.xml', 'src/test/java/suites/regressionTests.xml'], description: 'Choose suite to run')
